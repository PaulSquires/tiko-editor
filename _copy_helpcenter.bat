...
rem
rem   C:\dev\HelpCenter\site  ->  settings\help\helpcenter
rem
rem The Help Center window (F1) loads settings\help\helpcenter\index.html through WebView2.
...
rem
rem /MIR mirrors, which means it DELETES files in settings\help\helpcenter that are no longer in
...
set DSTDIR=%~dp0settings\help\helpcenter
