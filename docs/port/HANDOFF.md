...
10. [`7c-step7.md`](7c-step7.md) — **the item that took three steps to justify, and the
    ...
    wanted to hear.
11. [`7c-step24.md`](7c-step24.md) — **geometry that answered nothing before the first
...
12. [`7c-step23.md`](7c-step23.md) — **a note that outlived its own condition, and a gate
...
13. [`7c-step22.md`](7c-step22.md) — **a correct decision wired to nothing.** Read "The
...
14. [`7c-step21.md`](7c-step21.md) — **the right button was a DEFECT, and two of the
...
15. [`7c-step20.md`](7c-step20.md) — **the step where the first three reverts all came
    ...
    tiko's original.
16. [`7c-step19.md`](7c-step19.md) — **the Explorer pane, and three defects each found
    ...
    corner cut.
17. [`7c-step18.md`](7c-step18.md) — **a whole portability class that every gate was blind
...
18. [`7c-step17.md`](7c-step17.md) — **three bug reports, three different verdicts, and the
...
19. [`7c-step16.md`](7c-step16.md) — **phase 7c's code meets Linux, and the step where I made
...
20. [`7c-step15.md`](7c-step15.md) — **the step where a revert-to-red falsified the CORRECTION,
    ...
    these hooks exist".
21. [`7c-step14.md`](7c-step14.md) — **READ "What this step is really about".** Every stale
...
22. [`7c-step13.md`](7c-step13.md) — **the step where the live list emptied, and four of its
...
23. [`7c-step12.md`](7c-step12.md) — **the step where the revert-to-red pass caught the SUITES
...
24. [`7c-step11.md`](7c-step11.md) — **the step that started as an encoding bug and was
...
25. [`7c-step10.md`](7c-step10.md) — **three items closed, three false comments, and one of
...
26. [`7c-step9.md`](7c-step9.md) — **the encoding step, and the third blocker in three steps
...
27. [`7c-step8.md`](7c-step8.md) — **the step where two blockers turned out to have been
...
28. [`webview2-decision.md`](webview2-decision.md) — the constraint that page called
...
| `_run_shell.bat --selftest` | the shell's own suite — **481 assertions** (2026-08-17; +2 step 18, +17 step 19, +12 step 20, +17 step 21, +9 step 22, +12 step 23, +17 the action icons in step 24) | green |
...
| PsPlatform `pstree` | **342 assertions** (242 → 271 step 8, → 290 step 21, → 326 step 23's label editor, → 342 step 24's left-click hook and the layout fix) | green |
