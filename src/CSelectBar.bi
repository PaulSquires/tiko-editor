...
#define CSELECTBAR_HOTTRACK_MS    100
...
' Create; CSelectBar_SetPadding takes raw pixels thereafter.
#define CSELECTBAR_DEFAULT_PADLEFT   12
#define CSELECTBAR_DEFAULT_PADRIGHT  12
...
#define CSELECTBAR_DEFAULT_INDICATORH    2
#define CSELECTBAR_DEFAULT_INDICATORGAP  4
...
' CIconPanel, where selection is a multi-valued SET and therefore genuinely belongs on the
' item -- a distinction worth keeping straight when copying between the two.
type CSELECTBAR_PANEL
...
'   - Draw with the SAME font you handed to CSelectBar_SetFont. The control measured the
...
type SEL_PaintPanelCallbackSub as sub( byval p as CSELECTBAR_PAINTINFO ptr )
...
' subsequent click to this control (the CListBox bug recorded in Learnings.md).
' Suppressing WM_LBUTTONDOWN suppresses the press, never the capture bookkeeping.
type SEL_MessageCallbackFunc as function( byval m as CSELECTBAR_MESSAGEINFO ptr ) as boolean
...
' Deliberately NO fallback to the panel's caption (which CStatusBar and CTabBar do): the
...
' updated, so CSelectBar_GetCurSel() = idxNew. Programmatic SetCurSel does NOT fire this --
...
type CSELECTBAR
    ...
    panels(any)       as CSELECTBAR_PANEL
    ...
    ' needs (three separate sites in CTabBar.bi alone, and the family's most repeated bug
    ...
    nPadLeft          as long = CSELECTBAR_DEFAULT_PADLEFT       ' DPI-scaled at Create
    nPadRight         as long = CSELECTBAR_DEFAULT_PADRIGHT      ' DPI-scaled at Create
    nIndicatorHeight  as long = CSELECTBAR_DEFAULT_INDICATORH    ' DPI-scaled at Create
    nIndicatorGap     as long = CSELECTBAR_DEFAULT_INDICATORGAP  ' DPI-scaled at Create
    ...
    declare function AddPanel() as CSELECTBAR_PANEL ptr                     ' append
    declare function GetPanel( byval idx as long ) as CSELECTBAR_PANEL ptr
...
' tail clips at the client edge: rects are computed honestly rather than squeezed (CTabBar's
' rule), so hit-testing stays correct for free and the cursor cannot reach past the edge.
sub CSELECTBAR.LayoutPanels()
...
function CSELECTBAR.GetCount() as long
    return this.panelCount
end function

function CSELECTBAR.IsValidPanel( byval idx as long ) as boolean
    return (idx >= 0) andalso (idx < this.panelCount)
end function

function CSELECTBAR.GetPanel( byval idx as long ) as CSELECTBAR_PANEL ptr
...
function CSELECTBAR.HitTest( byval x as long, byval y as long ) as long
    dim as POINT pt
    pt.x = x
    pt.y = y
    for i as long = 0 to this.panelCount - 1
...
function CSELECTBAR.AddPanel() as CSELECTBAR_PANEL ptr
...
'
' THE CONTROL HANDLE
'   Every CSelectBar_* function takes the handle returned by CSelectBar_Create().
'
...
' ----------------------------------------------------------------------------------------
declare function CSelectBar_Create( byval hWndParent as HWND, byval CtrlID as long ) as HWND
...
' ----------------------------------------------------------------------------------------
declare function CSelectBar_AddPanel( byval hSelectBar as HWND, byval Text as DWSTRING, byval id as long = 0, byval itemData as integer = 0 ) as long
declare sub      CSelectBar_Clear( byval hSelectBar as HWND )
declare sub      CSelectBar_Refresh( byval hSelectBar as HWND )
...
'   included) or -1.
' ----------------------------------------------------------------------------------------
declare function CSelectBar_GetCount( byval hSelectBar as HWND ) as long
declare function CSelectBar_IsValidPanel( byval hSelectBar as HWND, byval idx as long ) as boolean
declare function CSelectBar_FindPanelByID( byval hSelectBar as HWND, byval id as long ) as long
declare function CSelectBar_HitTest( byval hSelectBar as HWND, byval x as long, byval y as long ) as long
...
' ----------------------------------------------------------------------------------------
declare function CSelectBar_GetText( byval hSelectBar as HWND, byval idx as long ) as DWSTRING
declare function CSelectBar_SetText( byval hSelectBar as HWND, byval idx as long, byval Text as DWSTRING ) as boolean
declare function CSelectBar_GetPanelID( byval hSelectBar as HWND, byval idx as long ) as long
declare function CSelectBar_SetPanelID( byval hSelectBar as HWND, byval idx as long, byval id as long ) as boolean
declare function CSelectBar_GetItemData( byval hSelectBar as HWND, byval idx as long ) as integer
declare function CSelectBar_SetItemData( byval hSelectBar as HWND, byval idx as long, byval itemData as integer ) as boolean
declare function CSelectBar_GetEnabled( byval hSelectBar as HWND, byval idx as long ) as boolean
declare function CSelectBar_SetEnabled( byval hSelectBar as HWND, byval idx as long, byval isEnabled as boolean ) as boolean
...
' ----------------------------------------------------------------------------------------
declare function CSelectBar_GetCurSel( byval hSelectBar as HWND ) as long
declare function CSelectBar_SetCurSel( byval hSelectBar as HWND, byval idx as long ) as boolean
...
' ----------------------------------------------------------------------------------------
declare sub      CSelectBar_GetPadding( byval hSelectBar as HWND, byref nPadLeft as long, byref nPadRight as long )
declare sub      CSelectBar_SetPadding( byval hSelectBar as HWND, byval nPadLeft as long, byval nPadRight as long )
declare function CSelectBar_SetPanelPadding( byval hSelectBar as HWND, byval idx as long, byval nPadLeft as long, byval nPadRight as long ) as boolean
declare sub      CSelectBar_GetIndicator( byval hSelectBar as HWND, byref nThickness as long, byref nGap as long )
declare sub      CSelectBar_SetIndicator( byval hSelectBar as HWND, byval nThickness as long, byval nGap as long )
declare function CSelectBar_GetPanelRect( byval hSelectBar as HWND, byval idx as long, byref rc as RECT ) as boolean
declare function CSelectBar_GetPanelTextRect( byval hSelectBar as HWND, byval idx as long, byref rc as RECT ) as boolean
declare function CSelectBar_GetPanelIndicatorRect( byval hSelectBar as HWND, byval idx as long, byref rc as RECT ) as boolean
declare function CSelectBar_GetIdealWidth( byval hSelectBar as HWND ) as long
...
' ----------------------------------------------------------------------------------------
declare sub      CSelectBar_GetColors( byval hSelectBar as HWND, byval pColors as CSELECTBAR_COLORS ptr )
declare sub      CSelectBar_SetColors( byval hSelectBar as HWND, byval pColors as CSELECTBAR_COLORS ptr )
declare function CSelectBar_GetFont( byval hSelectBar as HWND ) as HFONT
declare function CSelectBar_SetFont( byval hSelectBar as HWND, byval hPanelFont as HFONT ) as boolean
declare function CSelectBar_GetTooltipHandle( byval hSelectBar as HWND ) as HWND
declare sub      CSelectBar_SetHoverTime( byval hSelectBar as HWND, byval milliseconds as long )

' ----------------------------------------------------------------------------------------
' Tooltips.  Per-panel text wins; the callback is consulted only for panels with none; a
' panel with neither shows no tip.
' ----------------------------------------------------------------------------------------
declare function CSelectBar_GetTooltipText( byval hSelectBar as HWND, byval idx as long ) as DWSTRING
declare function CSelectBar_SetTooltipText( byval hSelectBar as HWND, byval idx as long, byval Text as DWSTRING ) as boolean
...
' ----------------------------------------------------------------------------------------
declare sub      CSelectBar_SetPaintPanelCallback( byval hSelectBar as HWND, byval usersub as SEL_PaintPanelCallbackSub )
declare sub      CSelectBar_SetMessageCallback( byval hSelectBar as HWND, byval userfunc as SEL_MessageCallbackFunc )
declare sub      CSelectBar_SetTooltipCallback( byval hSelectBar as HWND, byval userfunc as SEL_TooltipCallbackFunc )
declare sub      CSelectBar_SetSelChangeCallback( byval hSelectBar as HWND, byval usersub as SEL_SelChangeCallbackSub )
