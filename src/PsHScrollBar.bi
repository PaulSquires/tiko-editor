...
'
'    A self-contained, per-instance control seeded from PsVScrollBar (its vertical
...
'    PsHScrollBar_SetRange( total, page, pos ) and is told about user scrolling
...
function PSHSCROLLBAR.TrackWidth() as integer
    dim as RECT rc : GetClientRect( this.hWin, @rc )
    return rc.right - rc.left
end function

function PSHSCROLLBAR.MaxPos() as integer
...
function PSHSCROLLBAR.NeedsThumb() as boolean
...
function PSHSCROLLBAR.PosFromThumbLeft( byval thumbLeft as integer ) as integer
...
' ----------------------------------------------------------------------------------------
' PUBLIC API
' All PsHScrollBar_* functions take the handle returned by PsHScrollBar_Create().
' ----------------------------------------------------------------------------------------
declare function PsHScrollBar_Create( byval hWndParent as HWND, byval CtrlID as integer ) as HWND
declare sub      PsHScrollBar_SetRange( byval hSB as HWND, byval nTotal as integer, byval nPage as integer, byval nPosition as integer )
declare function PsHScrollBar_GetPos( byval hSB as HWND ) as integer
declare sub      PsHScrollBar_SetPos( byval hSB as HWND, byval nPosition as integer )
declare function PsHScrollBar_NeedsThumb( byval hSB as HWND ) as boolean
declare function PsHScrollBar_IsDragging( byval hSB as HWND ) as boolean
declare sub      PsHScrollBar_SetColors( byval hSB as HWND, byval backclr as COLORREF, byval foreclr as COLORREF, byval foreclrhot as COLORREF )
declare sub      PsHScrollBar_SetPaintCallback( byval hSB as HWND, byval usersub as HScrollPaintCallbackSub )
declare sub      PsHScrollBar_SetScrollCallback( byval hSB as HWND, byval usersub as HScrollCallbackSub )
...
' ----------------------------------------------------------------------------------------
declare function PsHScrollBar_HandleWheelDelta( byval hSB as HWND, byval nDelta as integer ) as boolean
declare sub      PsHScrollBar_SetWheelStep( byval hSB as HWND, byval nUnitsPerNotch as integer )
declare function PsHScrollBar_GetWheelStep( byval hSB as HWND ) as integer
