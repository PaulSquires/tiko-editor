...
#define PSSTATUSBAR_HOTTRACK_MS    100


' Default horizontal inset applied to each side of a panel's text when measuring. The
' control DPI-scales this at Create; PsStatusBar_SetPadding takes raw pixels thereafter.
#define PSSTATUSBAR_DEFAULT_PADDING  8
...
type PSSTATUSBAR_PANELINFO
    Text      as DWSTRING
    itemData  as integer         ' id to invoke if clicked on
    nMinWidth as integer = 0     ' floor for this panel's width; 0 = auto-size to text
    rc        as RECT            ' computed client coordinates (see PSSTATUSBAR.LayoutPanels)
end type

type PSSTATUSBAR_PAINTINFO
...
'   - Draw with the SAME font you handed to PsStatusBar_SetFont. The control measured the
'     panel widths with it; a different font means the widths lie.
'   - Inset your text by PsStatusBar_GetPadding( p->hStatusBar ). That padding was added to
...
type PSSTATUSBAR
    ...
    nPadding        as integer = PSSTATUSBAR_DEFAULT_PADDING   ' DPI-scaled at Create
    bLayoutDirty    as boolean = true

    declare sub      LayoutPanels()
    declare function GetCount() as integer                                  ' panel count
    declare function InsertPanelAt( byval idx as integer ) as PSSTATUSBAR_PANELINFO ptr
    declare function AddPanel() as PSSTATUSBAR_PANELINFO ptr                       ' append
    declare function GetPanel( byval idx as integer ) as PSSTATUSBAR_PANELINFO ptr
...
sub PSSTATUSBAR.LayoutPanels()
    ...
    for i as integer = 0 to this.panelCount - 1
        ...
        if nChars > 0 then
            dim as SIZE sz
            if GetTextExtentPoint32W( hDC, this.panels(i).Text.Wz(), nChars, @sz ) then
                textW = sz.cx
            end if
        end if
...
function PSSTATUSBAR.GetCount() as integer
    return this.panelCount
end function

function PSSTATUSBAR.IsValidPanel( byval idx as integer ) as boolean
    return (idx >= 0) andalso (idx < this.panelCount)
end function

function PSSTATUSBAR.GetPanel( byval idx as integer ) as PSSTATUSBAR_PANELINFO ptr
...
function PSSTATUSBAR.InsertPanelAt( byval idx as integer ) as PSSTATUSBAR_PANELINFO ptr
    if idx < 0 then idx = 0
...
function PSSTATUSBAR.AddPanel() as PSSTATUSBAR_PANELINFO ptr
    return this.InsertPanelAt( this.panelCount )
end function

function PSSTATUSBAR.DeletePanelAt( byval idx as integer ) as boolean
...
'
' THE CONTROL HANDLE
'   Every PsStatusBar_* function takes the handle returned by PsStatusBar_Create(). 
'
...
' ----------------------------------------------------------------------------------------
declare function PsStatusBar_Create( byval hWndParent as HWND, byval CtrlID as integer ) as HWND

' ----------------------------------------------------------------------------------------
' Adding / removing panels.  Add* and Insert* return the new panels's index, or -1.
' ----------------------------------------------------------------------------------------
declare function PsStatusBar_AddPanel( byval hStatusBarControl as HWND, byval Text as DWSTRING, byval itemData as integer = 0 ) as integer
declare function PsStatusBar_InsertPanel( byval hStatusBarControl as HWND, byval idx as integer, byval Text as DWSTRING, byval itemData as integer = 0 ) as integer
declare function PsStatusBar_DeletePanel( byval hStatusBarControl as HWND, byval idx as integer ) as boolean
declare sub      PsStatusBar_Clear( byval hStatusBarControl as HWND )
declare sub      PsStatusBar_Refresh( byval hStatusBarControl as HWND )

' ----------------------------------------------------------------------------------------
' Counts.  GetCount = every panel in the control.
' ----------------------------------------------------------------------------------------
declare function PsStatusBar_GetCount( byval hStatusBarControl as HWND ) as integer

' ----------------------------------------------------------------------------------------
' Panel contents.  Set* return FALSE for an invalid panel index.
' ----------------------------------------------------------------------------------------
declare function PsStatusBar_GetText( byval hStatusBarControl as HWND, byval idx as integer ) as DWSTRING
declare function PsStatusBar_SetText( byval hStatusBarControl as HWND, byval idx as integer, byval Text as DWSTRING ) as boolean
declare function PsStatusBar_GetItemData( byval hStatusBarControl as HWND, byval idx as integer ) as integer
declare function PsStatusBar_SetItemData( byval hStatusBarControl as HWND, byval idx as integer, byval itemData as integer ) as boolean
declare function PsStatusBar_GetItemRect( byval hStatusBarControl as HWND, byval idx as integer ) as RECT
...
'   always current.
' ----------------------------------------------------------------------------------------
declare function PsStatusBar_GetPanelMinWidth( byval hStatusBarControl as HWND, byval idx as integer ) as integer
declare function PsStatusBar_SetPanelMinWidth( byval hStatusBarControl as HWND, byval idx as integer, byval nMinWidth as integer ) as boolean
declare function PsStatusBar_GetExpandPanel( byval hStatusBarControl as HWND ) as integer
declare function PsStatusBar_SetExpandPanel( byval hStatusBarControl as HWND, byval idx as integer ) as boolean
declare function PsStatusBar_GetPadding( byval hStatusBarControl as HWND ) as integer
declare sub      PsStatusBar_SetPadding( byval hStatusBarControl as HWND, byval nPadding as integer )
declare function PsStatusBar_GetPanelRect( byval hStatusBarControl as HWND, byval idx as integer, byref rc as RECT ) as boolean

' ----------------------------------------------------------------------------------------
' Appearance.  The font is borrowed, never owned: keep it alive and destroy it yourself.
' ----------------------------------------------------------------------------------------
declare function PsStatusBar_GetBackColor( byval hStatusBarControl as HWND ) as COLORREF
declare function PsStatusBar_SetBackColor( byval hStatusBarControl as HWND, byval clr as COLORREF ) as COLORREF
declare function PsStatusBar_GetFont( byval hStatusBarControl as HWND ) as HFONT
...
' ----------------------------------------------------------------------------------------
declare sub      PsStatusBar_SetPaintCallback( byval hStatusBarControl as HWND, byval usersub as SB_PaintCallbackSub )
declare sub      PsStatusBar_SetMessageCallback( byval hStatusBarControl as HWND, byval userfunc as SB_MessageCallbackFunc )
declare sub      PsStatusBar_SetTooltipCallback( byval hStatusBarControl as HWND, byval userfunc as SB_TooltipCallbackFunc )
