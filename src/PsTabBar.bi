...
#define PSTABBAR_HOTTRACK_MS    100


' Default horizontal inset applied to each side of a tab's text when measuring. The
' control DPI-scales this at Create; PsTabBar_SetPadding takes raw pixels thereafter.
#define PSTABBAR_DEFAULT_PADDING  8
...
' hover. DPI-scaled at Create; PsTabBar_SetIconWidth takes raw pixels thereafter.
#define PSTABBAR_DEFAULT_ICONWIDTH  20
...
'   - Draw with the SAME font you handed to PsTabBar_SetFont. The control measured the
...
' where it is IGNORED. The control holds mouse capture across a press (unlike PsStatusBar,
...
' (the PsListBox bug recorded in Learnings.md). Suppressing WM_LBUTTONDOWN suppresses
...
' decides: prompt to save, veto by doing nothing, or call PsTabBar_DeleteTab itself.
...
' you after. Programmatic PsTabBar_MoveTab does NOT fire this (the SetCurSel rule:
...
type PSTABBAR
    ...
    '     PsStatusBar, and deliberately: the close-X cancel semantics (press the X, slide
    '     off, release, nothing happens) and Phase 5's drag both consume the guaranteed
    '     down->up pairing. It pays PsVScrollBar's full price: release on the up-message
    ...
    nPadding        as integer = PSTABBAR_DEFAULT_PADDING     ' DPI-scaled at Create
    nIconWidth      as integer = PSTABBAR_DEFAULT_ICONWIDTH   ' DPI-scaled at Create
    ...
    declare function InsertTabAt( byval idx as integer ) as PSTABBAR_TABINFO ptr
    declare function AddTab() as PSTABBAR_TABINFO ptr                       ' append
    declare function GetTab( byval idx as integer ) as PSTABBAR_TABINFO ptr
...
sub PSTABBAR.LayoutTabs()
    ...
    for i as integer = 0 to this.tabCount - 1
        ...
        if nChars > 0 then
            dim as SIZE sz
            if GetTextExtentPoint32W( hDC, this.tabs(i).Text.Wz(), nChars, @sz ) then
                textW = sz.cx
            end if
        end if
...
function PSTABBAR.GetCount() as integer
    return this.tabCount
end function

function PSTABBAR.IsValidTab( byval idx as integer ) as boolean
    return (idx >= 0) andalso (idx < this.tabCount)
end function

function PSTABBAR.GetTab( byval idx as integer ) as PSTABBAR_TABINFO ptr
...
function PSTABBAR.InsertTabAt( byval idx as integer ) as PSTABBAR_TABINFO ptr
    if idx < 0 then idx = 0
...
function PSTABBAR.AddTab() as PSTABBAR_TABINFO ptr
    return this.InsertTabAt( this.tabCount )
end function

function PSTABBAR.DeleteTabAt( byval idx as integer ) as boolean
...
'
' THE CONTROL HANDLE
'   Every PsTabBar_* function takes the handle returned by PsTabBar_Create().
'
...
' ----------------------------------------------------------------------------------------
declare function PsTabBar_Create( byval hWndParent as HWND, byval CtrlID as integer ) as HWND
...
' ----------------------------------------------------------------------------------------
declare function PsTabBar_AddTab( byval hTabBar as HWND, byval Text as DWSTRING, byval itemData as integer = 0 ) as integer
declare function PsTabBar_IsValidTab( byval hTabBar as HWND, byval idx as integer ) as boolean
declare function PsTabBar_InsertTab( byval hTabBar as HWND, byval idx as integer, byval Text as DWSTRING, byval itemData as integer = 0 ) as integer
declare function PsTabBar_DeleteTab( byval hTabBar as HWND, byval idx as integer ) as boolean
declare function PsTabBar_MoveTab( byval hTabBar as HWND, byval idxFrom as integer, byval idxTo as integer ) as boolean
declare sub      PsTabBar_Clear( byval hTabBar as HWND )
declare sub      PsTabBar_Refresh( byval hTabBar as HWND )

' ----------------------------------------------------------------------------------------
' Counts.  GetCount = every tab in the control.
' ----------------------------------------------------------------------------------------
declare function PsTabBar_GetCount( byval hTabBar as HWND ) as integer

' ----------------------------------------------------------------------------------------
' tab contents.  Set* return FALSE for an invalid tab index.
' ----------------------------------------------------------------------------------------
declare function PsTabBar_GetText( byval hTabBar as HWND, byval idx as integer ) as DWSTRING
declare function PsTabBar_SetText( byval hTabBar as HWND, byval idx as integer, byval Text as DWSTRING ) as boolean
declare function PsTabBar_GetItemData( byval hTabBar as HWND, byval idx as integer ) as integer
declare function PsTabBar_SetItemData( byval hTabBar as HWND, byval idx as integer, byval itemData as integer ) as boolean
...
' ----------------------------------------------------------------------------------------
declare function PsTabBar_GetTabMinWidth( byval hTabBar as HWND, byval idx as integer ) as integer
declare function PsTabBar_SetTabMinWidth( byval hTabBar as HWND, byval idx as integer, byval nMinWidth as integer ) as boolean
declare function PsTabBar_GetPadding( byval hTabBar as HWND ) as integer
declare sub      PsTabBar_SetPadding( byval hTabBar as HWND, byval nPadding as integer )
declare function PsTabBar_GetIconWidth( byval hTabBar as HWND ) as integer
declare sub      PsTabBar_SetIconWidth( byval hTabBar as HWND, byval nIconWidth as integer )
declare function PsTabBar_GetTabRect( byval hTabBar as HWND, byval idx as integer, byref rc as RECT ) as boolean
declare function PsTabBar_GetTabParts( byval hTabBar as HWND, byval idx as integer, byref rcPaint as RECT, byref rcText as RECT, byref rcIcon as RECT, byref rcClose as RECT ) as boolean
...
' ----------------------------------------------------------------------------------------
declare function PsTabBar_GetCurSel( byval hTabBar as HWND ) as integer
declare function PsTabBar_SetCurSel( byval hTabBar as HWND, byval idx as integer ) as boolean
...
' ----------------------------------------------------------------------------------------
declare function PsTabBar_GetFirstVisible( byval hTabBar as HWND ) as integer
declare function PsTabBar_SetFirstVisible( byval hTabBar as HWND, byval idx as integer ) as boolean
declare function PsTabBar_Navigate( byval hTabBar as HWND, byval nDirection as integer ) as integer
declare function PsTabBar_CanNavigate( byval hTabBar as HWND, byval nDirection as integer ) as boolean
...
' ----------------------------------------------------------------------------------------
declare function PsTabBar_GetBackColor( byval hTabBar as HWND ) as COLORREF
declare function PsTabBar_SetBackColor( byval hTabBar as HWND, byval clr as COLORREF ) as COLORREF
declare function PsTabBar_GetBorderColor( byval hTabBar as HWND ) as COLORREF
declare function PsTabBar_SetBorderColor( byval hTabBar as HWND, byval clr as COLORREF ) as COLORREF
declare function PsTabBar_GetBorderWidth( byval hTabBar as HWND ) as integer
declare sub      PsTabBar_SetBorderWidth( byval hTabBar as HWND, byval nBorderWidth as integer )
...
'                       PsTabBar_DeleteTab yourself.
'   ReorderCallback   - a drag moved a tab; one callback per live move, state already
'                       updated. Programmatic MoveTab is silent.
' ----------------------------------------------------------------------------------------
declare sub      PsTabBar_SetPaintCallback( byval hTabBar as HWND, byval usersub as TB_PaintCallbackSub )
declare sub      PsTabBar_SetMessageCallback( byval hTabBar as HWND, byval userfunc as TB_MessageCallbackFunc )
declare sub      PsTabBar_SetTooltipCallback( byval hTabBar as HWND, byval userfunc as TB_TooltipCallbackFunc )
declare sub      PsTabBar_SetSelChangeCallback( byval hTabBar as HWND, byval usersub as TB_SelChangeCallbackSub )
declare sub      PsTabBar_SetCloseCallback( byval hTabBar as HWND, byval usersub as TB_CloseCallbackSub )
declare sub      PsTabBar_SetReorderCallback( byval hTabBar as HWND, byval usersub as TB_ReorderCallbackSub )
