...
type DB2_DATA
    ...
    ElementName   as DWSTRING            ' Function name / Variable Name / TYPE Name
    ElementData   as DWSTRING            ' Generic text data related to ElementName (todo text, etc)
    CallTip       as DWSTRING            ' Function Calltip associated with ElementName variable
    Variabletype  as DWSTRING            ' The type of variable this is. Could be a TYPE name.
...
type clsDB2
    ...
    public:  
        ...
        declare function dbSeek( byval sParentName as DWSTRING, byval sLookFor as DWSTRING, byval Action as integer, byval sFilename as DWSTRING = "" ) as DB2_DATA ptr
        declare function dbFindFunction( byref sFunctionName as DWSTRING, byref sFilename as DWSTRING = "" ) as DB2_DATA ptr
        declare function dbFindFunctionTYPE( byref sTypeName as DWSTRING, byref sFunctionName as DWSTRING ) as DB2_DATA ptr
        declare function dbFindVariable( byref sParentName as DWSTRING, byref sVariableName as DWSTRING ) as DB2_DATA ptr
        declare function dbFindTYPE( byref sTypeName as DWSTRING ) as DB2_DATA ptr
