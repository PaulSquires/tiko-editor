...
' ==========================================================================================
' dbginfo - reader for the debug information fbc embeds with -g -gen gas / -gen gas64.
'
...
type DBG_FIELD
    nm         as string
    typeId     as long
    descTypeId as long         ' see DBG_VAR.descTypeId
    ptrDepth   as long
...
type DBG_VAR
    nm         as string
    typeId     as long
    ' For a dynamic array this is the FBARRAY descriptor's type, kept because typeId has
    ' been collapsed to the ELEMENT type and the run-time bounds live in the descriptor.
    descTypeId as long
    ptrDepth   as long
    arrayIndex as long
    scope      as DBG_SCOPE
