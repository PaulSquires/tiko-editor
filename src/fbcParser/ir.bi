...
''
''
'' fbcParser: the gas/gas64/hlc/llvm codegen backends were removed; the null
'' backend (ir-null.bas) is the only one left and is always selected.
extern as IR_VTBL irnull_vtbl
declare sub irInit( )
declare sub irEnd( )
