...
'' fbcParser: upstream never freed string lists (they lived until process
'' exit); repeated scans need them released. Same pattern as strsetEnd().
sub strlistEnd(byval list as TLIST ptr)
