...
' ==========================================================================================
' modDebugProcess - launches the debuggee and owns every interaction with it.
'
' Pairs with modDebugInfo, which supplies the line and symbol tables this drives off.
'
' ------------------------------------------------------------------------------------------
...
#include once "modDebugInfo.bi"

' Posted to the notify window. Well clear of tiko's own MSG_USER_* block, which is an
' unnumbered enum based at WM_USER + 1 and currently runs to about WM_USER + 15.
const as long MSG_USER_DEBUG_STOPPED = WM_USER + 810   ' wParam = DBG_STOPREASON
